...
var Icon$5 = function (props) {
    return (React.createElement(Svg, { xmlns: "http://www.w3.org/2000/svg", width: "59", height: "59", fill: "none", version: "1.1", viewBox: "0 0 59 59" },
        React.createElement("circle", { cx: "29.5", cy: "29.5", r: "29.5", fill: "#FEC803" }),
        React.createElement("path", { stroke: "#373737", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "3", d: "M19.862 29.533h19.276" }),
        React.createElement("path", { stroke: "#373737", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "3", d: "M29.5 19.895l9.638 9.638-9.638 9.639" })));
};
...
var Icon$7 = function (props) {
    return (React.createElement(Svg, { xmlns: "http://www.w3.org/2000/svg", width: "25", height: "25", fill: "none", viewBox: "0 0 25 25" },
        React.createElement("path", { stroke: "#F0B90B", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "2", d: "M8.428 4.166v15.91M16.383 20.075V4.166M12.974 7.576l3.409-3.409 3.409 3.41M11.837 16.666l-3.409 3.41-3.409-3.41" })));
};

var Icon$8 = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 24 25" }, props, { xmlns: "http://www.w3.org/2000/svg", width: "39", height: "39", fill: "none", version: "1.1" }),
        React.createElement("circle", { cx: "19.5", cy: "19.5", r: "19", stroke: "#F0B90B" }),
        React.createElement("path", { stroke: "#f0b90b", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "2", d: "M23.47 27.447v-15.91" }),
        React.createElement("path", { stroke: "#f0b90b", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "2", d: "M15.515 11.538v15.909" }),
        React.createElement("path", { stroke: "#f0b90b", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "2", d: "M20.06 14.948l3.41-3.41 3.408 3.41" }),
        React.createElement("path", { stroke: "#f0b90b", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "2", d: "M18.924 24.038l-3.41 3.409-3.408-3.41" })));
};
    ...
    return (React.createElement(Svg, __assign({ viewBox: "0 0 80 80" }, props),
        ...
        React.createElement("defs", null,
            React.createElement("linearGradient", { id: "paint0_linear", x1: "40.9849", y1: "37.4118", x2: "31.978", y2: "71.0261", gradientUnits: "userSpaceOnUse" },
                ...
                React.createElement("stop", { offset: "1", stopColor: "#FEC803" })),
...
var Icon$K = function (_a) {
    ...
    return (React.createElement(Svg, __assign({ xmlns: "http://www.w3.org/2000/svg", width: 24, height: 24, viewBox: "0 0 24 24", fill: "none" }, props),
        React.createElement("circle", { cx: 12, cy: 12, r: 12, fill: textColor }),
        React.createElement("path", { d: "M15.079 12.235h2.483c-.116.555-.224 1.073-.334 1.592-.037.18-.092.356-.112.538-.019.176-.104.214-.263.212-.678-.006-1.357.007-2.035-.007-.202-.004-.267.074-.306.257-.238 1.122-.486 2.242-.73 3.363-.008.04-.019.08-.035.143h-.244c-2.4-.003-4.799-.004-7.198-.01-.447-.002-.893-.027-1.34-.042-.122-.004-.24-.012-.212-.19l.347-2.243c.487 0 .949.002 1.41 0 1.688-.012 3.375-.03 5.063-.031.22 0 .296-.07.338-.283.205-1.019.43-2.033.644-3.05.299-1.423.599-2.846.888-4.271.04-.2.11-.267.321-.266 1.713.01 3.426.006 5.138.006h.287c-.157.752-.311 1.474-.459 2.197-.035.172-.159.14-.27.14-.893.001-1.787.008-2.68-.005-.228-.003-.323.074-.363.292-.1.536-.218 1.07-.338 1.658z", fill: "#fec803" }),
        React.createElement("path", { d: "M9.986 7.986h2.394c-.023.171-.035.317-.064.46-.333 1.645-.67 3.29-1.004 4.935-.093.456-.185.912-.27 1.37-.03.157-.098.225-.264.224-.637-.004-1.275.004-1.912.01-.173.002-.261-.044-.22-.25.447-2.232.888-4.467 1.34-6.749zM8.775 10.001L8.51 11.32c-.23 1.139-.466 2.277-.69 3.417-.034.174-.103.238-.276.238a94.7 94.7 0 00-1.958.015c-.218.004-.28-.091-.239-.291.12-.586.234-1.172.36-1.756.196-.9.402-1.798.596-2.699.04-.182.113-.254.312-.249.628.016 1.256.006 1.884.006h.276zM13.723 7.383l.329-1.817h2.495c-.101.57-.198 1.135-.305 1.697-.01.046-.08.115-.124.115-.783.007-1.568.005-2.395.005z", fill: "#fec803" })));
};
...
// `;
styled(Icon$L)(templateObject_4$1 || (templateObject_4$1 = __makeTemplateObject(["\n  animation: ", " 1s ease-in-out infinite;\n  transform: translate3d(0, 0, 0);\n"], ["\n  animation: ", " 1s ease-in-out infinite;\n  transform: translate3d(0, 0, 0);\n"])), float);
var Spinner = function (_a) {
    var _b = _a.size, size = _b === void 0 ? 256 : _b, img = _a.img;
    return (React.createElement(Container$1, null,
        React.createElement("img", { src: img, width: size + "px" })));
};
var templateObject_1$s, templateObject_2$6, templateObject_3$2, templateObject_4$1;
...
var templateObject_1$t, templateObject_2$7, templateObject_3$3, templateObject_4$2, templateObject_5;
...
var Accordion = function (_a) {
    ...
    return (React.createElement(Container$2, null,
        React.createElement(MenuEntry, { onClick: handleClick, className: className },
            ...
            isOpen ? React.createElement(Icon$a, null) : React.createElement(Icon$9, null)),
    ...
    return (React.createElement(Container$4, null,
        React.createElement(SocialEntry, null,
            cakePriceUsd ? (React.createElement(PriceLink, { href: "https://pancakeswap.info/token/0x0e09fabb73bd3ade0a17ecc321fd13a19e81ce82", target: "_blank" },
                React.createElement(Icon$K, { isDark: isDark, width: "24px", mr: "8px" }),
...
var templateObject_1$H, templateObject_2$e, templateObject_3$8, templateObject_4$4, templateObject_5$1;
...
var lightColors = __assign(__assign(__assign({}, baseColors), brandColors), { background: "#FAF9FA", backgroundDisabled: "#C7C7C7", contrast: "#FFFFFF", invertedContrast: "#FFFFFF", input: "rgba(241, 241, 241, 0.4)", tertiary: "#EFF4F5", text: "#373737", textDisabled: "#777777", textSubtle: "#373737", borderColor: "#E9EAEB", card: "#FFFFFF", button: "linear-gradient(90deg, #919191 0%, #272727 100%)", gradients: {
        bubblegum: "linear-gradient(139.73deg, #E6FDFF 0%, #F3EFFF 100%)",
    } });
var darkColors = __assign(__assign(__assign({}, baseColors), brandColors), { secondary: "#FEC803", background: "#2B2B2B", backgroundDisabled: "#C7C7C7", contrast: "#FFFFFF", invertedContrast: "#343434", input: "#444444", primaryDark: "#0098A1", tertiary: "#444444", text: "#FFFFFF", textDisabled: "#777777", textSubtle: "#FFFFFF", borderColor: "#524B63", card: "#343434", button: "linear-gradient(90deg, #FEC803 0%, #7C6A25 100%)", gradients: {
